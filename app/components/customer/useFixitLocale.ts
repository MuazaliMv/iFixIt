...
const COPY={
 ...
 step:{en:'Step',dv:'ފިޔަވަޅު'},of:{en:'of',dv:'ގެ'},service:{en:'Service',dv:'ޚިދުމަތް'},whatHelp:{en:'What do you need help with?',dv:'ކޮން ކަމަކުން އެހީ ބޭނުން؟'},chooseService:{en:'Choose one service. You can describe the work in the next step.',dv:'ޚިދުމަތެއް ހޮވާ. މަސައްކަތް ތަފްޞީލު ދެން އޮތް ފިޔަވަޅުގައި ލިޔެވޭނެ.'},choose:{en:'Choose',dv:'ހޮވާ'},selected:{en:'Selected',dv:'ހޮވިފައި'},
