...
const labels={
 brand:{en:'FixIt',dv:'ފިކްސްއިޓް'},home:{en:'Home',dv:'މައި ޞަފްޙާ'},requests:{en:'My Requests',dv:'މަގޭ ރިކުއެސްޓްތައް'},newRequest:{en:'New Request',dv:'އައު ރިކުއެސްޓް'},main:{en:'Main',dv:'މައިން'},maldives:{en:'Maldives service marketplace',dv:'މޯލްޑިވްސް ސަރވިސް މާކެޓްޕްލޭސް'}
} as const;

export default function CustomerSidebar({language,setLanguage,onNewRequest}:Props){
