...
export default function ProviderMenuPage(){
 ...
 return <main className="providerModePage"><div className="providerModeShell">
  <header className="providerModeTop"><div><span className="modeBadge provider"><span className="modeDot provider"/>Provider</span><h1>Menu</h1><p>Manage customer work, services, availability, earnings and account settings.</p></div><div style={{display:'flex',alignItems:'center',justifyContent:'flex-end',gap:10,flexWrap:'wrap'}}><AppModeSwitch mode="provider" compact/><button className="secondary" type="button" onClick={()=>void logout()} aria-label="Log out of provider account">Log Out</button></div></header>
