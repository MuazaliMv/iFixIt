...
export default function ProviderMenuPage(){
 ...
 return <main className="providerModePage"><div className="providerModeShell">
  <header className="providerModeTop"><div><span className="modeBadge provider"><span className="modeDot provider"/>Provider</span><h1>Menu</h1><p>Customer requests, provider settings, earnings, reviews and verification.</p></div><AppModeSwitch mode="provider" compact/></header>
  <section className="providerModeCard"><div className="providerModeHero"><div><span className="modeBadge provider">{state.status}</span><h2>{state.name}</h2><p>{state.providerApproved?'Your provider account is approved and can receive matched customer requests.':'Your provider setup is not fully approved yet.'}</p></div><a className="primary" href="/provider/setup">Provider Setup</a></div></section>
  <section className="providerMenuGrid"><a className="providerMenuCard" href="/provider/jobs"><span><strong>Customer Requests</strong><small>Matched requests waiting for your response</small></span><b>›</b></a><a className="providerMenuCard" href="/provider/earnings"><span><strong>Earnings</strong><small>Revenue and completed work</small></span><b>›</b></a><a className="providerMenuCard" href="/provider/listings"><span><strong>Listings</strong><small>Services, pricing and descriptions</small></span><b>›</b></a><a className="providerMenuCard" href="/provider/calendar"><span><strong>Availability</strong><small>Weekly schedule and bookings</small></span><b>›</b></a><a className="providerMenuCard" href="/provider/setup"><span><strong>Verification & payout</strong><small>{state.providerApproved?'Approved':'Review provider setup'}</small></span><b>›</b></a><a className="providerMenuCard" href="/profile"><span><strong>Account profile</strong><small>Identity and contact settings</small></span><b>›</b></a><a className="providerMenuCard" href="/provider/messages"><span><strong>Messages</strong><small>Customer conversations after acceptance</small></span><b>›</b></a></section>
