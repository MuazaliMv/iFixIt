  ...
  <section className="profileSection">
   <div className="profileSectionHeader">
    <div>
     ...
     <p className="sectionLead">Review your subscription and the documents required for provider approval.</p>
    </div>
    <a className="secondary" href="/profile">Account Profile</a>
   </div>
  </section>
