...
export default function ProviderSubscriptionPage(){
 ...
 return <main className="providerModePage"><div className="providerModeShell">
  <header className="providerModeTop"><div><span className="modeBadge provider"><span className="modeDot provider"/>Provider</span><h1>Subscription</h1><p>Keep provider access active and continue receiving customer requests.</p></div><div className="providerHeaderActions"><AppModeSwitch mode="provider" compact/><button className="secondary" type="button" onClick={()=>void logout()}>Log Out</button></div></header>
