...
export default function ProfileClient(){
 ...
 return <main className="profileRedesignPage"><div className="profileRedesignShell"><div className="profileRedesignGrid">
  ...
  <div className="profileContentColumn">
   ...
   <section className="profileSecurityCard"><div><p className="profileInfoEyebrow">SECURITY & ACCOUNT</p><h2>Account controls</h2></div><div className="profileInfoGrid"><div><small>Phone verification</small><strong>{profile?.phone_number?(profile.is_phone_verified?'Verified':'Unverified'):'Not available'}</strong></div></div><div className="profileSecurityActions"><a className="secondary" href="/change-password">Change Password</a><a className="secondary" href="/notifications">Notifications</a><button className="profileSignOutButton" type="button" onClick={signOut}>Sign Out</button></div></section>
  </div>
 </div></div></main>;
}