...
export default function ProfileClient(){
 ...
 return <main className="profileRedesignPage"><div className="profileRedesignShell"><div className="profileRedesignGrid">
  ...
  <div className="profileContentColumn">
   ...
   <section className="profileSecurityCard"><div><p className="profileInfoEyebrow">CONTACT</p><h2>Phone verification</h2><p>{profile?.is_phone_verified?'Your phone number has been verified.':'Verify your phone number to improve account security.'}</p></div><div className="profileSecurityActions"><a className="secondary" href="/verify-phone">Verify Phone</a></div></section>
