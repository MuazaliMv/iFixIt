...
export default function ProfileClient(){
 ...
 return <main className="profileRedesignPage"><div className="profileRedesignShell"><div className="profileRedesignGrid">
  ...
  <div className="profileContentColumn">
   ...
   <section className="profileInfoCard"><div><p className="profileInfoEyebrow">ACCOUNT SECURITY</p><h2>Phone verification</h2></div><div className="profileInfoGrid"><div><small>Phone number</small><strong>{profile?.phone_number?`+960 ${localPhone(profile.phone_number)}`:'Not provided'}</strong></div><div><small>Verification status</small><strong>{profile?.phone_number?(profile.is_phone_verified?'Verified':'Unverified'):'Not available'}</strong></div></div></section>
