...
export default function ProfileClient(){
 ...
 return <main className="profileRedesignPage"><div className="profileRedesignShell"><div className="profileRedesignGrid">
  ...
  <div className="profileContentColumn">
   ...
   <section className="profileSecurityCard"><div><p className="profileInfoEyebrow">SECURITY & ACCOUNT</p><h2>Account controls</h2></div><div className="profileSecurityActions"><a className="secondary" href="/change-password">Change Password</a><button className="profileSignOutButton" type="button" onClick={signOut}>Sign Out</button></div></section>
  </div>
 </div></div></main>;
}