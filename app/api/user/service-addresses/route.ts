...
function adminClient(){
 ...
 if(!key)throw new Error('Service Address server configuration is incomplete.');
...
async function currentUser(client:ReturnType<typeof adminClient>,token:string){
