  ...
  return (
    <main style={{ minHeight: '70vh', display: 'grid', placeItems: 'center', padding: 24 }}>
      <section role="alert" style={{ width: 'min(520px, 100%)', background: '#fff', border: '1px solid #e5e7eb', borderRadius: 20, padding: 24, boxShadow: '0 12px 36px rgba(0,0,0,.08)' }}>
        ...
        <p style={{ margin: 0, color: '#5f6368', lineHeight: 1.5 }}>Your last action may not have been saved. Try the page again, or move to a safe section of FixIt instead of getting stuck.</p>
        ...
        <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', marginTop: 18 }}>
          ...
          <button type="button" onClick={() => { window.location.href = '/requests'; }}>Requests</button>
