...
function BackIcon(){return <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="m15 18-6-6 6-6"/></svg>}
function UserIcon(){return <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><circle cx="12" cy="8" r="4"/><path d="M4 21a8 8 0 0 1 16 0"/></svg>}
...
export default function ChangePasswordPage(){
 ...
 return <main className="cpPage">
  <header className="cpAppBar">
   <div className="cpAppBarInner">
    <div className="cpBrandGroup">
     <button type="button" className="cpBack" onClick={()=>history.back()} aria-label="Go back"><BackIcon/></button>
     <a href="/" className="cpBrand"><span>iF</span><strong>iFixMV</strong></a>
    </div>
    <a href="/profile" className="cpProfile"><UserIcon/><span>Profile</span></a>
   </div>
  </header>
