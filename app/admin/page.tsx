...
export default function AdminPage(){
 ...
 return <main className="shell">
  ...
  <section className="panel"><div className="panelHeader"><div><p className="eyebrow">ACTION REQUIRED</p><h2>Admin attention</h2><p className="muted">{actionTotal?`${actionTotal} item${actionTotal===1?'':'s'} currently need review.`:'No urgent admin actions are currently waiting.'}</p></div></div><div className="adminStats">
  ...
  <section className="panel"><div className="panelHeader"><div><p className="eyebrow">OPERATIONS</p><h2>Marketplace status</h2></div></div><div className="adminStats">
   <a className="statCard" href="/admin/requests"><span>All Service Requests</span><strong>{counts.total}</strong></a>
   <a className="statCard" href="/admin/requests"><span>In Progress</span><strong>{counts.inProgress}</strong></a>
   <a className="statCard" href="/admin/requests"><span>Completed</span><strong>{counts.completed}</strong></a>
   <a className="statCard" href="/admin/providers"><span>Providers</span><strong>{providerCount}</strong></a>
   <a className="statCard" href="/admin/users"><span>Users</span><strong>{userCount}</strong></a>
   <a className="statCard" href="/admin/requests"><span>Cancelled</span><strong>{counts.cancelled}</strong></a>
  </div></section>
