...
export default function AdminPage(){
 ...
 return <main className="shell">
  <header className="topbar"><div><a className="brand" href="/admin">FixIt</a><p className="tagline">Admin Control Center</p></div><div className="actions"><a className="secondary" href="/profile">Profile</a><button className="secondary" onClick={signOut}>Sign Out</button></div></header>
  <AdminNav />
