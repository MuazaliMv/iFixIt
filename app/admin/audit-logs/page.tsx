...
export default function AdminAuditLogsPage(){
 ...
 return <main className="shell"><header className="topbar"><div><a className="brand" href="/admin">FixIt</a><p className="tagline">Admin • Audit Logs</p></div></header><AdminNav />
